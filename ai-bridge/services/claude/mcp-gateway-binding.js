...
/**
 * Java 侧下发的 Gateway 绑定材料。
 * @typedef {{ enabled?: boolean; ready?: boolean; command?: string[]; revision?: number | string }} GatewayBinding
 */
...
/**
 * 判定 binding 是否可用于生成 mcpServers。兼作类型守卫:返回 true 时收窄为 GatewayBinding。
 *
 * @param {GatewayBinding | null | undefined} binding
 * @returns {binding is GatewayBinding}
 */
 ...
 *
 * @param {GatewayBinding | null | undefined} binding
 * @returns {{ [serverId: string]: { type: 'stdio'; command: string; args: string[] } } | null}
 */
