...
import DependencySection from '../../../../src/components/settings/DependencySection/index';
...
const translations: Record<string, string> = {
  ...
  'settings.dependency.opencodeSdkDescription': 'OpenCode AI 功能所需。包含 OpenCode SDK。',
...
describe('DependencySection', () => {
  ...
  it('removes the custom version input and keeps a compact version selector with actions', () => {
    ...
    expect(screen.getByRole('button', { name: '目标版本 v0.1.0' })).toBeTruthy();
