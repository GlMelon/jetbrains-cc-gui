...
import AppearanceTab from '../../../../src/components/settings/BasicConfigSection/AppearanceTab';
import styles from '../../../../src/components/settings/BasicConfigSection/style.module.less';
