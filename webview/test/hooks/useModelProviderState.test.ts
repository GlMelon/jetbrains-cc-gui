...
import { useModelProviderState } from '../../src/hooks/useModelProviderState';
...
vi.mock('../../src/bridge/typed', async () => {
  const actual = await vi.importActual<typeof import('../../src/bridge/typed')>('../../src/bridge/typed');
