...
public class ClaudeCliSessionPromptTest {
    ...
    public void rendersImageAttachmentWithReadToolInstruction() throws Exception {
        ...
        CliSendRequest request = new CliSendRequest("tab-claude-prompt", "claude", "describe this image", null, null, List.of(), null, List.of(), null, null, null, null, null, null, Map.of());
