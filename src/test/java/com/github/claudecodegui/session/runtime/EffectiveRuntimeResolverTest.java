...
public class EffectiveRuntimeResolverTest {
    ...
    public void resolvesEveryProviderFromCurrentPolicyDefault() {
        ...
        assertEquals(RuntimeType.CLI, EffectiveRuntimeResolver.resolve(ProviderType.CLAUDE.toLowerCase(), policy).runtimeType());
        assertEquals(RuntimeType.SDK, EffectiveRuntimeResolver.resolve(ProviderType.CODEX.toLowerCase(), policy).runtimeType());
        assertEquals(RuntimeType.CLI, EffectiveRuntimeResolver.resolve(ProviderType.OPENCODE.toLowerCase(), policy).runtimeType());
    }
    ...
    public void policyChangeTakesEffectWithoutSessionSnapshot() {
        ...
        assertFalse(EffectiveRuntimeResolver.isCliMode(ProviderType.CLAUDE.toLowerCase(), sdkPolicy));
        assertTrue(EffectiveRuntimeResolver.isCliMode(ProviderType.CLAUDE.toLowerCase(), cliPolicy));
    }
    ...
    public void disabledProviderFailsFast() {
        ...
        assertThrows(IllegalStateException.class,
                () -> EffectiveRuntimeResolver.resolve(ProviderType.CODEX.toLowerCase(), policy));
    }
    ...
    public void missingProviderIsFilledFromBackendDefaults() {
        ...
        assertEquals(RuntimeType.CLI,
                EffectiveRuntimeResolver.resolve(ProviderType.CLAUDE.toLowerCase(), partial).runtimeType());
        assertEquals(RuntimeType.SDK,
                EffectiveRuntimeResolver.resolve(ProviderType.OPENCODE.toLowerCase(), partial).runtimeType());
    }
