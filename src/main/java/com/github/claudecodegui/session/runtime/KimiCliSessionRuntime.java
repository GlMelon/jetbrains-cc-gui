...
/**
 * Kimi CLI runtime adapter。
 * 将 SessionRequest 转换为 CliSendRequest，委托给 CliSessionManager。
 */
public class KimiCliSessionRuntime implements SessionRuntime {

    private final CliSessionManager cliManager;

    public KimiCliSessionRuntime(CliSessionManager cliManager) {
    ...
    public void interrupt(String tabId) {
        cliManager.interrupt(tabId, ProviderType.KIMI.value());
    }
