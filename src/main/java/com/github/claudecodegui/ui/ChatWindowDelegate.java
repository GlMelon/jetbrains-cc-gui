...
import com.github.claudecodegui.handler.agent.*;
...
import com.github.claudecodegui.handler.cli.UninstallCliToolActionHandler;
...
import com.github.claudecodegui.handler.diff.*;
...
import com.github.claudecodegui.handler.file.*;
import com.github.claudecodegui.handler.history.*;
import com.github.claudecodegui.handler.importer.McpServerImportHandler;
import com.github.claudecodegui.handler.mcp.*;
...
import com.github.claudecodegui.handler.prompt.*;
import com.github.claudecodegui.handler.provider.*;
...
import com.github.claudecodegui.handler.session.*;
import com.github.claudecodegui.handler.settings.*;
import com.github.claudecodegui.handler.skill.*;
import com.github.claudecodegui.handler.tab.CreateNewTabActionHandler;
import com.github.claudecodegui.handler.window.*;
...
public class ChatWindowDelegate {
    ...
    public void syncActiveProvider() {
        try {
            ...
            if (repaired) {
                LOG.info("[ClaudeChatToolWindow] Repaired missing provider fields in global settings");
            } else {
                LOG.info("[ClaudeChatToolWindow] No missing provider fields to repair");
            }
        } catch (Exception e) {
...
nodeService.setSessionId(sessionId);
    ...
    public void initializeHandlers() {
        ...
        typedHandlers.add(new UninstallCliToolActionHandler());
