 ...
 *
 * <p>Migrated from upstream feature/v0.5.5 (commits 285778ba + 95a36fa8).
 * Batches multiple JS calls into one {@code executeJavaScript} via
 * {@link #buildBatchScript}, coalesces consecutive delta calls, replaces
 * latest-only state calls, and invalidates pending work on browser
 * replacement so stale events never reach a new webview instance.</p>
 */
